...
var FileButtonComponent =
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(FileButtonComponent, _BaseComponent);

  _createClass(FileButtonComponent, null, [{
    key: "schema",
    ...
    get: function get() {
      return {
        ...
        weight: 100,
        schema: FileButtonComponent.schema()
      };
    }
  }]);

  function FileButtonComponent(component, options, data) {
    var _this;

    _classCallCheck(this, FileButtonComponent);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FileButtonComponent).call(this, component, options, data));
    _this.support = {
  ...
  _createClass(FileButtonComponent, [{
    key: "getValue",
    ...
    value: function buildFileList() {
      ...
      }, [this.dataValue.map(function (fileInfo, index) {
    ...
    value: function buildUpload() {
      ...
      }, [this.buildBrowseButton()])] : [this.ce('div', {}, [this.video = this.ce('video', {
        class: 'video',
        autoplay: true
    ...
    key: "buildBrowseButton",
    value: function buildBrowseButton() {
      this.browseButton = this.ce('button', {
        class: 'btn btn-primary'
      });

      if (this.component.buttonLeftIcon) {
        this.browseButton.appendChild(this.ce('span', {
          class: this.component.buttonLeftIcon
        }));
        this.browseButton.appendChild(this.text(' '));
      }

      this.browseButton.appendChild(this.text(this.component.buttonLabel));

      if (this.component.buttonRightIcon) {
        this.browseButton.appendChild(this.text(' '));
        this.browseButton.appendChild(this.ce('span', {
          class: this.component.buttonRightIcon
        }));
      }

      this.addFocusBlurEvents(this.browseButton);
    ...
    key: "defaultSchema",
    get: function get() {
      return FileButtonComponent.schema();
    }
  }, {
    key: "emptyValue",
    get: function get() {
    ...
    key: "defaultValue",
    get: function get() {
      var value = _get(_getPrototypeOf(FileButtonComponent.prototype), "defaultValue", this);
...
exports.default = FileButtonComponent;